...
function SponsoredSpend({ asset, config, payment, payments, close, notify, onComplete }: {
  ...
  // Both partial payments and full withdrawals use the destination the user reviewed.
